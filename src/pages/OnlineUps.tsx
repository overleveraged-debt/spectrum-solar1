          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="reveal">
              ...
              <div className="flex flex-wrap gap-3">
                {(pageData.advancedFeatures || ["Double Conversion Technology","Pure Sine Wave Output","Intelligent Battery Management","Overload Protection","Short Circuit Protection","LCD Display & Monitoring","Remote Management","Bypass Mode","Scalable Capacity"]).map((tag: string, i: number) => (
