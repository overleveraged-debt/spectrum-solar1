            ...
            {products.map((product, index) => (
              <div key={product.id} className="reveal group" style={{ transitionDelay: `${index * 80}ms` }}>
                ...
                >
                  ...
                  />
                  <div className="flex items-center gap-6 md:gap-10 p-6 md:p-8 pl-8 md:pl-10">
                    <span
                      className="text-[11px] font-black uppercase tracking-[0.3em] tabular-nums flex-shrink-0 transition-colors duration-500"
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-baseline gap-3 md:gap-5">
                        <h3 className="text-base md:text-3xl font-black uppercase text-white tracking-tight leading-none">
                          {product.title}
                        </h3>
                        <span
                          className="text-[9px] font-black uppercase tracking-[0.25em] px-3 py-1.5 rounded-full flex-shrink-0 transition-all duration-500"
                          style={{
                        ...
                        {product.badge && (
                          <span className="text-[9px] font-black uppercase tracking-[0.2em] px-3 py-1.5 rounded-full bg-yellow-400/10 text-yellow-400 border border-yellow-400/30 flex-shrink-0">
                            {product.badge}
                          </span>
                        )}
                      </div>
                      <p className="text-zinc-500 text-[11px] font-bold uppercase tracking-widest mt-2 hidden md:block">
                        {product.tagline}
                      </p>
                    </div>
                    <div
