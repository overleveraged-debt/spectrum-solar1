...
import {
  Zap, Sun, Battery, ArrowRight, ShieldCheck, CheckCircle2,
      ...
      <section className="py-24 md:py-32 px-6 bg-zinc-900/40 border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 md:mb-20 reveal">
            ...
            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">How Hybrid Solar Works</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="sm:col-span-2 lg:col-span-1 lg:row-span-2 reveal bg-yellow-400 rounded-[2rem] p-8 flex flex-col justify-between min-h-[220px] lg:min-h-[400px] group hover:shadow-[0_0_50px_rgba(250,204,21,0.2)] transition-all">
              ...
              <div>
                ...
                <h3 className="text-black text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight">Never Worry<br />About Cuts</h3>
      ...
      <section className="py-24 md:py-32 px-6 bg-zinc-900/50 border-y border-white/5">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 md:mb-16 reveal">
            ...
            <h2 className="text-3xl md:text-6xl font-black uppercase tracking-tighter">Hybrid vs On-Grid vs Off-Grid</h2>
          </div>
          ...
          <div className="reveal bg-zinc-950 border border-white/5 rounded-[2rem] overflow-hidden shadow-2xl">
            ...
            {[
              ...
              <div key={i} className="grid grid-cols-4 border-b border-white/5 last:border-0">
                <div className="py-4 px-3 md:px-6 text-xs md:text-sm font-semibold text-zinc-300">{row.feature}</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="reveal">
              ...
              <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-6 md:mb-8">Advanced<br />Technology</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-5 gap-10 md:gap-12 items-start">
            ...
            <div className="lg:col-span-2 space-y-3">
              {[
                { icon: Home, label: "Homes with Frequent Power Cuts", sub: "Stay comfortable round the clock" },
                { icon: Hospital, label: "Hospitals & Clinics", sub: "Critical equipment always powered" },
                { icon: Monitor, label: "IT Offices & Workspaces", sub: "Zero downtime for computers & servers" },
                { icon: ShoppingBag, label: "Retail Shops & Businesses", sub: "Never miss a billing moment" },
                { icon: Building2, label: "Commercial Buildings", sub: "Large-scale solar with battery backup" },
              ].map((item, i) => (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="space-y-5">
              {[
                { title: "Site Inspection", desc: "Engineer visits your site to assess roof area, load requirements, and backup needs.", icon: Settings },
                { title: "Load & Backup Analysis", desc: "We calculate your exact power consumption to design the ideal solar + battery combination.", icon: FileText },
                { title: "Custom System Design", desc: "Hybrid system engineered to your specific needs — panel capacity, battery size and inverter rating.", icon: Activity },
                { title: "Installation & Setup", desc: "Professional installation with clean wiring, panel mounting and inverter configuration.", icon: Wrench },
                { title: "Testing & Activation", desc: "Complete commissioning, switchover testing and personal app setup walkthrough.", icon: Play },
              ].map((step, i) => (
        ...
        <div className="max-w-7xl mx-auto reveal">
          <div className="relative bg-yellow-400 rounded-[2.5rem] md:rounded-[3rem] p-10 md:p-20 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-10">
              <div>
                <div className="text-black/50 text-[10px] font-black uppercase tracking-[0.4em] mb-3">Upgrade to Smart Energy</div>
