    ...
    <div className="bg-white text-black pb-20 overflow-x-hidden min-h-screen">
      ...
      <section className="pt-16 pb-20">
        <div className="max-w-4xl mx-auto px-6 prose prose-zinc prose-a:text-yellow-600">
          <h2 className="text-2xl font-medium mb-4 uppercase tracking-tight">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-medium mb-4 uppercase tracking-tight mt-10">2. Services and Products</h2>
          <p className="mb-6 text-zinc-600 font-light leading-relaxed">
          ...
          <h2 className="text-2xl font-medium mb-4 uppercase tracking-tight mt-10">3. Quotations and Pricing</h2>
          <p className="mb-6 text-zinc-600 font-light leading-relaxed">
          ...
          <h2 className="text-2xl font-medium mb-4 uppercase tracking-tight mt-10">4. Partnership Programs (Franchise, Dealership, Freelance)</h2>
          <p className="mb-6 text-zinc-600 font-light leading-relaxed">
          ...
          <h2 className="text-2xl font-medium mb-4 uppercase tracking-tight mt-10">5. Intellectual Property</h2>
          <p className="mb-6 text-zinc-600 font-light leading-relaxed">
          ...
          <h2 className="text-2xl font-medium mb-4 uppercase tracking-tight mt-10">6. Limitation of Liability</h2>
          <p className="mb-6 text-zinc-600 font-light leading-relaxed">
          ...
          <h2 className="text-2xl font-medium mb-4 uppercase tracking-tight mt-10">7. Governing Law</h2>
          <p className="mb-6 text-zinc-600 font-light leading-relaxed">
          ...
          <h2 className="text-2xl font-medium mb-4 uppercase tracking-tight mt-10">8. Contact Information</h2>
          <p className="mb-6 text-zinc-600 font-light leading-relaxed">
