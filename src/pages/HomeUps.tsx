      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-3xl mx-auto">
              ...
              {(pageData.installationSteps || [
          {
                    ...
                    "desc": "Engineer assesses your home's load profile and power cut frequency."
          },
          {
                    "title": "Load Calculation",
                    "desc": "We calculate exactly which appliances to support and for how long."
          },
          {
                    "title": "System Selection",
                    "desc": "Right UPS capacity and battery selected for your specific needs."
          },
          {
                    "title": "Installation & Setup",
                    "desc": "Clean installation with proper wiring, earthing and safety testing."
          },
          {
                    "title": "Testing & Support",
                    "desc": "Full commissioning, hand-over demo and ongoing support program."
          }
