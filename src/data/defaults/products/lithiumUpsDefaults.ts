export const lithiumUpsDefaults = {
  metaTitle: "Lithium Inbuilt UPS Systems | Zero-Switch Backup | Spectrum Solar",
  metaDescription: "Smart, compact, and long-lasting lithium inbuilt UPS systems. Zero-switch technology for mission-critical power backup. Maintenance-free performance for homes and offices.",
  metaKeywords: "lithium inbuilt ups, zero switch ups, lithium inverter for home, lifepo4 ups battery, compact ups india",
  showHero: true,
  ...
  introImage: "/images/lithium_intro.webp",
  techImage: "/images/lithium_tech.webp",
  lifestyleImage: "/images/lithium_lifestyle.webp",
